    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 justify-center items-center mb-2'>
        <div className='flex flex-col w-full justify-center items-center text-center '>
          ...
          <div className='flex gap-3 mt-5'>
            <Button onClick={() => navigate("/ticketCenter")} textColor='text-primary' bgColor='bg-warning'>Tickets</Button>
            <Button onClick={() => navigate("/schedule")} textColor='text-black' bgColor='bg-primary'>Schedule</Button>
          </div>
        </div>
